...
urlpatterns = [
    ...
    # #create vendor
    # path('vendor-create/', views.vendor_create, name='vendor-list-create'),
    # #list of all vendors
    # path('vendors/', views.VendorList, name='vendor-list-get'),
    # #get vendor list by id
    # path('vendor/<int:pk>/', views.vendor_detail, name='vendor-detail'),
    # #Update/Put Vendors List/Details
    # path('vendor/update/<int:pk>', views.vendor_update, name='vendor-update'),
    # #delete vendor
    # path('vendor-delete/delete/<int:pk>/', views.vendor_delete, name='vendor-delete'),




    ###    ---- CLASS BASED VENDOR VIEWS URLS --------#####
    #create vendor
